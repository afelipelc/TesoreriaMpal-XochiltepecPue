...
Public Class AguaPotablefrm
    ...
    Sub CalculaTotal()
        If Me.DatosDtg.Rows.Count > 0 Then
            ...
            If Mostrados = "Canceladas" Or Mostrados = "Suspendidas" Or Mostrados = "CancelSusp" Then
                MessageBox.Show("Los adeudos mostrados pueden no ser los correctos." & Chr(13) & "Para ver el adeudo de alguna toma, elije la toma y haz clic en Cobrar", "Revisa el adeudo de una toma en Cobrar", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        End If
        ...
        Try
            ...
            For i = 1 To nTarifas
                ...
                For r = 0 To Me.DatosDtg.Rows.Count - 1
                    ...
                    If Mostrados <> "Activas" And Me.DatosDtg.Item(9, r).Value.ToString = "Cancelada" Or Me.DatosDtg.Item(9, r).Value.ToString = "Suspendida" Or Me.DatosDtg.Item(9, r).Value.ToString = "CancelSusp" Then
                        GoTo Siguiente
                    End If
                    'End If
                    ...
                    If Val(Me.DatosDtg.Item(2, r).Value.ToString) = Tarifa Then
                        ...
                        '############ aqui empieza nueva forma de calcalular
                        Dim TotalMeses As Integer
                        Dim AdeudoToma As Double
                        TotalMeses = 0
                        AdeudoToma = 0

                        'si el mes pagado es diciembre entonces inicia el periodo en el otro año
                        '***If PMes = 12 Then
                        '***PInicio = PAno + 1 & "01"
                        '***Else 'sino pago hasta diciembre, entonces contar a partir del mes pagado
                        ...
                        For d = 1 To Detalles 'recorrer los detalles
                            If Detalles > d Then 'si los detalles son mas del detalle actual
                                ...
                                If apar_mes(d + 1) = 1 Then 'si el mes de la siguiente tarifa es enero, entonces la tarifa actual termina en diciembre del año anterior
                                ...
                                If DatosMDR.HasRows = True Then
                                    ...
                                    AdeudoToma = AdeudoToma + DatosMDR!meses * costo(d) 'sumar el adeudo mas el nuevo adeudo de otra tarifa
                                End If
                                DatosMDR.Close()
                            ...
                            Else 'si es el ultimo detalle o el unico
                                ...
                                'aqui se puede agregar el periodo a los detalles
                            End If
                                'agregar los totales al grid
                                If Mostrados = "Todas" Or Mostrados = "Canceladas" Or Mostrados = "Suspendidas" Or Mostrados = "CancelSusp" Or Mostrados = "Buscar" Then
                                    Me.DatosDtg.Item(11, r).Value = AdeudoToma * Val(Me.DatosDtg.Item(1, r).Value.ToString)
                                Else
                                    Me.DatosDtg.Item(9, r).Value = AdeudoToma * Val(Me.DatosDtg.Item(1, r).Value.ToString)
                                End If
                        Next


                        '########### de aqui en adelante ya no sera necesario
...
Siguiente:
    ...
    Private Sub DatosDtg_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DatosDtg.CellDoubleClick
        ...
        If Mostrados = "CancelSusp" Or Mostrados = "Canceladas" Or Mostrados = "Suspendidas" Then
            MessageBox.Show("No se pueden modificar los datos de la toma porque esta esta suspendida o cancelada", "Tomas de agua potable", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
