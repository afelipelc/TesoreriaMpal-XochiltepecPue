            ...
            If PAno <= Now.Year Then ''verificar si es igual o mayor que la fecha actual "pago al corriente o adelantado"
                ...
                Else
                    If PFinPer <> "" Then 'si el usuario eligio pagar hasta
                        ...
                        Tope = True
                    Else 'sino el fin es el mes y año actual si llego el dia de cobro
                        FinAno = Now.Year 'año actual
                ...
                For d = 1 To Detalles 'recorrer los detalles
                    If Detalles > d Then 'si los detalles son mas del detalle actual
                        ...
                        If FinAno <= apar_ano(d + 1) And apar_mes(d + 1) < FinMes Then 'si el año final es menor del de la tarifa o si es igual y el mes es igual o menor del mes final
                        ...
                        Else
                            ...
                            Else 'sino tomar como fin de la taria hasta el mes anterior del inicio de la nueva tarifa
                                ...
                                End If
                            End If
                        End If 'fin si el año de la tarifa es menor que el año final
                    ...
                    Else 'si es el ultimo detalle o el unico
                        ...
                        'Aqui debemos comprobar si la toma esta cancelada o suspendida, si el usuario eligio pagar hasta, sino hay que tomar el mes y año actual
                        If FinMes < 10 Then
                            PFin = FinAno & "0" & FinMes
                        Else
                            PFin = FinAno & FinMes
