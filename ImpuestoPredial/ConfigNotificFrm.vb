...
Public Class ConfigNotificFrm
    ...
    Private Sub ConfigNotificFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If DatosMDR.HasRows = True Then
            ...
            Me.TextoTxt.Text = DatosMDR!textopredio.ToString
            DatosMDR.Close()
        End If
        DatosMDR.Close()
    End Sub
    ...
    Private Sub Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Aceptar.Click
        If Me.TesoreroTxt.Text <> "" And Me.TextoTxt.Text <> "" Then
            SQL = "UPDATE configuracion set tesorero = '" & Me.TesoreroTxt.Text & "', textopredio='" & Me.TextoTxt.Text & "'"
            DatosMCmd = New MySqlCommand
            DatosMCmd.CommandText = SQL
            DatosMCmd.Connection = SQLCnn
            ...
            Me.Close()
        Else
            MessageBox.Show("Escriba el texto que aparecerá en la notificación de adeudos", "Sistema de Impuesto Predial", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
End Class